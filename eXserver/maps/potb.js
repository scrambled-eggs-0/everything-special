...
spawnPosition.x=3100;
spawnPosition.y=3000;
...
// var numPts = 10;
// var conePts;
// function calcConePts(cam){
//     x -= cam.x;
//     y -= cam.y;
//     z -= cam.z;

//     const pt = [dot(cam.basis1, [x,y,z]) * canvas.w + canvas.w / 2, dot(cam.basis2, [x,y,z]) * canvas.w + canvas.h / 2];
    
//     return pt;
// }

// C(0,[],[0],{x:-1000,y:0,r:10,cr:(e)=>{
//     if(!startedConeRender) return;
//     // idea: approximate the cone as n triangles. Draw the triangles using linear transformations 

//     // subdivide the canvas into small rings. Each ring can be rendered as a 3d object.
//     // since we're projecting orthogonally, 
//     // Each ring has the same z, so 
// }})