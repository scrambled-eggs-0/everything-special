    ...
    const typeMap = {
        ...
        'rotate-normal': {
            ...
            customMap: (params) => {
                ...
                } else if(special === 'posc' || special === "poqt" || special === 'powc' || special === 'povv' || special === 'posh' || (special === 'pospd' && params.x > 3750/2 && params.y >11400/2 && params.x < 6100/2 && params.y < 13450/2)){
